        ...
        <div className="container relative max-w-screen-xl px-4 md:px-8 py-20 md:py-32">
          <div className="max-w-3xl space-y-8">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed max-w-2xl">
              ...
              and{" "}
              <span className="text-foreground font-medium">life&apos;s broader context</span>.
            </p>
        ...
        {recentPosts.length > 0 ? (
          ...
          <div className="text-center py-16 border border-dashed border-border rounded-lg">
            ...
            <p className="text-sm text-muted-foreground">
              Add MDX files to <code className="bg-muted px-2 py-1 rounded">content/blog/</code> to get started.
            </p>
          </div>
        )}
        ...
        <div className="container max-w-screen-xl px-4 md:px-8 py-16 md:py-24">
          <div className="max-w-2xl mx-auto text-center space-y-6">
            ...
            <p className="text-muted-foreground text-lg">
              Follow me on social media to get updates on new posts about web development,
