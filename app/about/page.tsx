				...
				<Card>
					<CardContent className="p-6 space-y-4">
						<p className="text-muted-foreground leading-relaxed">
							...
							reflects my belief that code doesn&apos;t exist in
							isolation—it&apos;s always embedded in a broader context of
							problems to solve, users to serve, and life to live.
						</p>
						<p className="text-muted-foreground leading-relaxed">
							Here you&apos;ll find deep dives into web development,
							explorations of AI and machine learning, programming tutorials,
							and occasionally, thoughts on life beyond the screen. I believe in
							learning in public and sharing knowledge freely.
						</p>
